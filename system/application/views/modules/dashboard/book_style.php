...
<?
		...
		if (!empty($row)):
            ...
            echo '<a href="javascript:(function(e,a,g,h,f,c,b,d){if(!(f=e.jQuery)||g>f.fn.jquery||h(f)){c=a.createElement(\'script\');c.type=\'text/javascript\';c.src=\'//ajax.googleapis.com/ajax/libs/jquery/\'+g+\'/jquery.min.js\';c.onload=c.onreadystatechange=function(){if(!b&&(!(d=this.readyState)||d==\'loaded\'||d==\'complete\')){h((f=e.jQuery).noConflict(1),b=1);f(c).remove()}};document.body.appendChild(c)}})(window,document,\'1.8.2\',function($,L){var s=document.createElement(\'script\');s.type=\'text/javascript\';s.src=\''.substr(url_from_file(__FILE__),5).'bmlt.js\';document.body.appendChild(s);s.onload=s.onreadystatechange=function(){bmlt($, \''.$login->email.'\', \''.$api_key.'\',\''.$book_id.'\',\''.confirm_slash(base_url()).$book->slug.'/api/add\')}});">Add to Scalar book '.htmlspecialchars($row->title).'</a>';
